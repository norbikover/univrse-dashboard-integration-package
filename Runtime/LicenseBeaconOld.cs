...
{
    public class LicenseBeaconOld : MonoBehaviour
    {
        [Header("Settings")]
        ...
        public async void StartBroadcast(string sceneName, ELicenseEnvironment environment)
        {
            ...
            string json = JsonConvert.SerializeObject(new LicenseMessageOld(sceneName, environment, Application.version));
